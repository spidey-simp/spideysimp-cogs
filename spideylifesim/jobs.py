...
ALLJOBS = {
    "Culinary": ["Aspiring chefs work their way up from scrubbing dishes to leading world-class kitchens and shaping food culture. This path is about mastering flavors, creating dining experiences, and making a mark on the culinary world.",
                ...
                "https://4.bp.blogspot.com/-QlM7Y04sO5w/TacdpJ0XPCI/AAAAAAAAA4w/bnjQVKerBRc/s200/anne+burrell.jpg",
                "Yo! Welcome to the kitchen! You might need a stove to get started at those cooking and baking skills! If ya have any questions, just hit me up dude!",
                "Dang dude was it something I said? Either way I'll take that stove back now since it's proprietary equipment."], 
    "Business": ["Starting from mailroom duties, you can climb the corporate ladder to lead entire companies. Business careers focus on management, sales, and innovative strategies that shape markets and industries.",
                ...
                "Welcome to the business branch. Here's a company laptop so you can get started on your job work. I look forward to working with you.",
                "No worries I get why you might've quit. Could I get the company laptop back though?"], 
    "Programming": ["Coders begin by troubleshooting simple issues and can evolve into industry-shaping innovators. This path emphasizes developing technical skills, creating software solutions, and transforming technology landscapes.",
                ...
                "https://valenciacollege.edu/future-students/images/computer-programming-promising-portrait-day-5-2444.jpg",
                "Hey! Weclome to the programming career! Let's get these bugs sorted out ASAP! Here's a laptop so you can get started on our code!"
                "Aw man I guess I'll find someone else to help with these bugs. Could I get the laptop back?"], 
    "Medicine": ["From hands-on patient care as interns to leading medical breakthroughs, this career revolves around improving and saving lives. Medicine combines patient-centered care with pioneering research.",
                ...
                "Dr. G. Home", ["Medical textbook"], ["Medicine"],
                "https://images5.fanpop.com/image/photos/31900000/Dr-Gregory-House-dr-gregory-house-31945640-1920-2560.jpg",
                "Look let's get a couple things straight! I am not your babysitter. I am not going to tolerate mediocrity. And everybody lies. Take this medical textbook and be ready for day one of your job or else."
                "I'd say I care, but I honestly don't. Enjoy your life. Or don't. Just give me that textbook back."],
    "LawEnforcement": ["Progressing from cadet training to overseeing public safety at a national level, this path emphasizes service, community protection, and justice. Law enforcement careers demand discipline, leadership, and integrity.",
                ...
                "https://i.pinimg.com/originals/34/55/7b/34557b655283d946d3d51b55894423f9.png",
                "The cap says you're the new recruit. Look I'm not going to bore you with any excess details. Here's your squad car keys. See you on your first day.",
                "Could I get those keys back? The cap ain't gonna be happy about this."],
    "Artist": ["Artists start by supporting established creators and can become world-renowned for their influence and creativity. This career celebrates personal expression, public impact, and contributions to culture.",
                ...
                "https://ichef.bbci.co.uk/images/ic/896xn/p0217xyb.jpg",
                "Well good day to you. Here's an extra easel I have so you can get started on your first masterpiece."
                "I had fun painting with you my friend. I hope you had fun too."],
    "Film": ["Careers in film range from amateur performances to shaping culture through iconic works. This journey is about storytelling, artistic collaboration, and leaving a mark on the entertainment industry.",
            ...
            "George Lupus", ["Movie script"], ["Acting"],
            "https://s.yimg.com/uu/api/res/1.2/oZnSnZXwx6hFFXUeOFfiaQ--~B/aD0yNzk1O3c9NDIwMDtzbT0xO2FwcGlkPXl0YWNoeW9u/https://media-mbst-pub-ue1.s3.amazonaws.com/creatr-images/2020-05/91267220-9c64-11ea-a5bc-eec71cf039d2",
            "Oh didn't see you there... Oh you're here to help? Grab a script. We have tons to do!",
            "Hey I'm cool with you leaving and all but there's several spoilers in that script, so I'm going to need it back."],
    "Military": ["Recruits can advance through ranks, shaping national strategy and global security. The military career ladder focuses on leadership, discipline, and defense.",
            ...
            "Major Havoc", ["Soldier garbs"], ["Athletic"],
            "https://assets.rebelmouse.io/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpbWFnZSI6Imh0dHBzOi8vYXNzZXRzLnJibC5tcy8xOTQ4MTM5NC9vcmlnaW4uanBnIiwiZXhwaXJlc19hdCI6MTYyNjk4NTY3MX0.kC7nB34V7PEHp0ZRK0PSUxOWpcVTIfUV_JWR23fcl40/img.jpg?width=980",
            "Step back in line private! Now put on this uniform and be prepared to listen to my every command!",
            "So, the soldier can't even follow simple orders. Alright well give that uniform back."],
    "Writing": ["Writers begin with simple contributions and can become masters who influence generations. This path explores storytelling, persuasive communication, and making an impact through words.",
            ...
            "https://www.thescottishsun.co.uk/wp-content/uploads/sites/2/2020/04/MEGA567544_JK_Rowling_037jpg-JS547350319.jpg",
            "Hmmmm how do I stay relevant? Oh are you the new contributor. Take this laptop and get to work.",
            "I personally applied to 13 publishers before I quit. I see you gave up much easier. I'll take that laptop back."],
    "SocialMedia": ["This career evolves from intern roles to shaping global social trends and strategies. It centers on creativity, engagement, and influence in the digital age.",
                ...
                "Marco Zuckerborg", ["Laptop"], ["Charisma"],
                "https://s2.glbimg.com/FUcw2usZfSTL6yCCGj3L3v3SpJ8=/smart/e.glbimg.com/og/ed/f/original/2019/04/25/zuckerberg_podcast.jpg",
                "I think it is important to remember that just about anyone can do just about anything. Let's get started. Here's a laptop.",
                "You're welcome to leave, but I will take that laptop back."],
    "Athletic": ["Athletes start with local competitions and can reach legendary status through skill, dedication, and leadership. This path focuses on sportsmanship, achievement, and inspiring others.",
                ...
                "LeBron Frames", ["Sporting equipment"], ["Athletic"],
                "https://images.hdqwalls.com/wallpapers/lebron-james-2020-bj.jpg",
                "Hey rookie! We need you on the court! Here's some sporting equipment! I'll see you out there, ok?",
                "No worries man. Being an athlete ain't easy. If I see you back on the court, I'll be sure to throw a pass your way."],
    "Legal": ["Legal professionals move from assisting attorneys to setting national legal precedents. The focus is on advocacy, justice, and shaping societal laws.",
            ...
            "Judge Duty", ["Casebook"], ["Debate"],
            "https://www.monstersandcritics.com/wp-content/uploads/2019/03/judge-judy.jpg",
            "Counselor, welcome to MY courtroom. My courtroom. My rules! I will kick you out if you can't adhere to the rules.",
            "Well that didn't last long. I'll take that casebook back now."],
    "Journalism": ["Reporters begin with local stories and can become globally respected figures for their integrity and impact. This career is about uncovering the truth and informing the public.",
            ...
            "J. Jonah Johnson", ["Notebook"], ["Writing", "Logic"],
            "https://i.pinimg.com/originals/76/8f/e5/768fe502bc70d3971983ddba1458a5a0.jpg",
            "You think you got spunk, huh? Well we'll see about that. Barker! Get in here and get the newbie their notebook!",
            "You think you can just quit from me? Well I don't accept your resignation! You're fired!"],
    "Engineering": ["Engineering careers start with hands-on learning and evolve into leading industry-changing projects. This path centers on innovation, problem-solving, and building solutions.",
            ...
            "Wright Angle", ["Toolbox", "Science workstation"], ["Science", "Handiness"],
            "https://www.umsl.edu/degrees/bachelors/images/overview-images/civil-engineering-umsl.jpg",
            "Hey! Welcome to engineering! Here's a toolbox and a science workstation to get you started! See you Monday!",
            "Dang I liked engineering with you. I'll take the tools back though."],
    "Music": ["Musicians can rise from street performances to shaping global music culture. The focus is on creativity, connection, and transforming sounds into timeless art."
            ...
            "https://img.welt.de/img/kultur/mobile208236547/4592509717-ci102l-w1024/Lana-Del-Rey-visits-107-7-The-End-in-Seattle.jpg",
            "It's like I always say 'Follow the Chemtrails under the Country Club and eventually you'll find a job in music'. Oh here's an electric piano for you!",
            "Some people are born to die, but it seems like you're born to quit. See ya."],
    "Science": ["Starting in labs, scientists can progress to reshaping human understanding and technology. Science careers prioritize discovery, innovation, and contributing to global knowledge.",
            ...
            "Dr. Alberto Sciencestein", ["Science workstation"], ["Science"],
            "https://upload.wikimedia.org/wikipedia/commons/d/d3/Albert_Einstein_Head.jpg",
            "For the millionth time I did not fail math in the third grade! Oh you're here for a job? Here's a science workstation so you can get started.",
            "You really can't teach a fish to climb a tree. I'll take that science workstation back now."],
    "Education": ["In the education field, aspiring professionals start by assisting teachers and learning how to engage students before advancing to leading entire schools and even transforming the field itself. This path is about nurturing minds, developing effective teaching practices, and driving educational innovation and reform.",
                ...
                "https://news.illinois.edu/files/6367/513046/111905.jpg",
                "Good morning to you. I trust you will take extra care to treat our students with excellence, and you yourself will excel in this career. Here's a notebook.",
    ...
    "Criminal": ["Those choosing the criminal career start with petty theft and work their way up to controlling massive criminal empires. This path emphasizes skill, risk, and a strategic approach to building a notorious reputation.",
                ...
                "https://i.pinimg.com/originals/b9/97/db/b997dbafbb8e75e939410c89f2ecfc69.jpg",
                "You're new to this, right? Well follow my lead, and I swear if you get us caught.",
                "Some people really aren't cut out for this line of work. Wish you well."],
    "Astronaut": ["Aspiring astronauts embark on intensive training, gaining experience in missions and leading innovative research in space. This career emphasizes bravery, scientific curiosity, and pushing humanity's frontiers beyond Earth.",
                ...
                "https://cdn.britannica.com/72/163272-050-1C5BC2B7/Neil-Armstrong-American.jpg",
                "That was one small application for you but hopefully one giant leap for mankind.",
                "Sorry you didn't enjoy your time here. Hope you find a better fit."],
...
Sailor = {
    ...
    "Sailor": ["A seasoned member of the crew, trusted to handle complex sailing duties.", 110, 250],
    "Quartermaster": ["Keeps order aboard, responsible for supplies, rations, and maintaining discipline.", 140, 350],
    "Navigator": ["Charts courses and guides the ship through perilous waters with expert precision.", 180, 450],
    "First Mate": ["Second-in-command, overseeing the daily activities of the crew and supporting the captain.", 230, 600],
    "Captain": ["Commands the entire ship, making strategic decisions and leading the crew to glory.", 300, 800],
...
ValiantKnight = {
    ...
    "Knight of the Realm": ["An established knight sworn to the service of their liege lord, upholding the laws of the land.", 150, 400],
    "Master-at-Arms": ["Oversees training of squires and knights-in-training, passing down refined combat skills and tactics.", 200, 500],
    "Banneret": ["Commands a small contingent of knights and soldiers, often leading missions or skirmishes.", 250, 700],
    "Knight Commander": ["Leads a larger force, making key strategic decisions in battle and trusted with greater responsibilities by their liege.", 350, 900],
